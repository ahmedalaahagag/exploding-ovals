...
function draw() {
    if(game.getCurrentGameState() === game.gameState.start) {
        ...
        text('color as the score ', windowWidth / 2 ,  windowHeight / 3 + 100)
        text('Every time you miss ' , windowWidth / 2,  windowHeight / 3 + 150)
        text('a right oval or misclick' , windowWidth / 2,  windowHeight / 3 + 200)
        text('you lose a point', windowWidth / 2,  windowHeight / 3 + 250)
        text('Dont let your score to 0', windowWidth / 2 ,  windowHeight / 3 +  300)
    ...
    if(game.getCurrentGameState() === game.gameState.gameOver) {
        ...
        text('Click to restart', windowWidth / 2 ,  windowHeight / 3 + 50)
    }
}
